    ...
    icon: (
      <div className="icon-circle">
        ...
        >
          ...
          />
          <path
            d="M19.3333 11.5C19.7475 11.5 20.0833 11.8358 20.0833 12.25V13.75C20.0833 14.1642 19.7475 14.5 19.3333 14.5C18.919 14.5 18.5833 14.1642 18.5833 13.75V12.25C18.5833 11.8358 18.919 11.5 19.3333 11.5Z"
            fill="#6852D6"
          />
          <path
            d="M13.3333 24.25C13.3333 23.8358 13.669 23.5 14.0833 23.5H24.5833C24.9975 23.5 25.3333 23.8358 25.3333 24.25C25.3333 24.6642 24.9975 25 24.5833 25H14.0833C13.669 25 13.3333 24.6642 13.3333 24.25Z"
            fill="#6852D6"
          />
          <path
            d="M13.7885 13.8946C13.4956 13.6017 13.0207 13.6017 12.7278 13.8946C12.435 14.1875 12.435 14.6624 12.7278 14.9553L13.7885 16.0159C14.0814 16.3088 14.5563 16.3088 14.8492 16.0159C15.1421 15.723 15.1421 15.2481 14.8492 14.9553L13.7885 13.8946Z"
            fill="#6852D6"
          />
          <path
            d="M25.9386 13.8946C26.2315 14.1875 26.2315 14.6624 25.9386 14.9553L24.8779 16.0159C24.585 16.3088 24.1102 16.3088 23.8173 16.0159C23.5244 15.723 23.5244 15.2481 23.8173 14.9553L24.8779 13.8946C25.1708 13.6017 25.6457 13.6017 25.9386 13.8946Z"
            fill="#6852D6"
          />
          <path
            d="M14.1364 20.5C14.5003 17.9558 16.6884 16 19.3333 16C21.9781 16 24.1662 17.9558 24.5301 20.5H26.8333C27.2475 20.5 27.5833 20.8358 27.5833 21.25C27.5833 21.6642 27.2475 22 26.8333 22H11.8333C11.419 22 11.0833 21.6642 11.0833 21.25C11.0833 20.8358 11.419 20.5 11.8333 20.5H14.1364Z"
            fill="#6852D6"
          />
        </svg>
      </div>
  ...
  return (
    <section className="partnership-section">
      <div className="container">
        ...
        <h2 className="title">Types of partnerships programs</h2>
